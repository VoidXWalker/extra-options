...
public class AccessibilityOptionsScreenMixin extends Screen {
    ...
    static {
        OPTIONS  = new net.minecraft.client.options.Option[] {
            net.minecraft.client.options.Option.NARRATOR,
            net.minecraft.client.options.Option.SUBTITLES,
            net.minecraft.client.options.Option.TEXT_BACKGROUND_OPACITY,
            net.minecraft.client.options.Option.TEXT_BACKGROUND,
            net.minecraft.client.options.Option.CHAT_OPACITY,
            net.minecraft.client.options.Option.AUTO_JUMP,
            Option.extra_options_DISTORTION_EFFECT_SCALE,
            Option.extra_options_FOV_EFFECT_SCALE,
            Option.extra_options_MONOCHROME_LOGO
        };
    }

    protected AccessibilityOptionsScreenMixin(Text title) { super(title); }
